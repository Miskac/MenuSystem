...
void UMultiplayerSessionsSubsystem::CreateSession(int32 NumPublicConnections, FString MatchType)
{
    ...
    // store the delegate in the f delegate handle so we can laiter remove it from the delegate list
...
void UMultiplayerSessionsSubsystem::JoinSession(FOnlineSessionSearchResult& SearchResult)
{
    if (!SessionInterface) 
    {
